...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_model.add_argument('--mlp_dim_occ', nargs='+', default=[256+1+64+13+3, 1024, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--mlp_dim_sdf', nargs='+', default=[256+1+64+13+3, 1024, 512, 256, 128, 4], type=int,
                             help='# of dimensions of mlp')

        g_model.add_argument('--use_tanh', action='store_true',
                             help='using tanh after last conv of image_filter network')
        g_model.add_argument('--mlp_dim_3d', nargs='+', default=[129, 1024, 512, 256, 128, 1], type=int, help='# of dimensions of mlp for DeepVoxels 3d branch')
