...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_model.add_argument('--mlp_dim', nargs='+', default=[256+64+13+3, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--mlp_dim_sdf', nargs='+', default=[256+64+13+3, 512, 256, 128, 4], type=int,
                             help='# of dimensions of mlp')
        g_model.add_argument('--mlp_dim_occ', nargs='+', default=[256+64+13+3, 512, 256, 128, 1], type=int,
                             help='# of dimensions of mlp')
